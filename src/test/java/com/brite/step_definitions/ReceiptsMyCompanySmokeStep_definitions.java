...
public class ReceiptsMyCompanySmokeStep_definitions {
    ...
    public void verify_AddAnItem_button_is_clickable() {
        ...
        BrowserUtils.isClickable(pages.getReceiptsMyCompanyPage().addAnItem);
    ...
    public void verify_Save_button_is_clickable() {
        ...
        BrowserUtils.isClickable(pages.getReceiptsMyCompanyPage().saveButton);
