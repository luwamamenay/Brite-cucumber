...
# -> connect to database and run sql that matches the front end data, and verify
#2)make change in front end and goto database and verify/validate
# -> make changes(add.update/delete) in front end
# -> connect to database and verify that changes are made in database tables as well
#3)make changes in database and verify in front end
# -> connect to db run sql that update/delete/insert
# -> goto front end app module where data is being displayed and verify
